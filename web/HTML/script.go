 ...
 * @Date: 2022-09-01 09:36:13
 * @LastEditors: xiongxinwei 3293172751nss@gmail.com
 * @LastEditTime: 2022-09-01 09:39:35
 * @FilePath: \coded:\文档\git\CS_COURSE\web\HTML\script.go
 * @Description:
 *
 *
 */
...
func main() {
	...
	for i := 1; i < 51; i++ {
		...
		write.WriteString("> ❤️💕💕HTML和CSS高级教程。更多的文章请移步博客Myblog:[http://nsddd.top](http://nsddd.top/)\n")
		write.WriteString("---\n")
