...
int main(int argc, char *argv[])
{
    ...
    // 源文件为 cvs文件 
    //ifstream sour("D:\\LW\\Sample_code_6_16_2012\\data_lable\\devel09_sour_lable.csv"); //声明文件流 
    ifstream sour("D:\\LW\\Sample_code_6_16_2012\\data_lable\\total\\data_sour_lable_total.csv"); //声明文件流 
