...
#define MAX_PWM           1700 //1800*10*2-1// 1800*2-1 //1700   //PWM1500速度对应490的脉冲 1ms 叉车
#define MIN_PWM            0
#define FOWARD             0
#define BACK               1
#define CanBoxPost         1
...
//上下叉 前后叉速度
 ...
 //叉车 物理参数
	float     s16dpl_d;          //底盘轮子直径
	float     s16dp_d;           //底盘直径
	float     s16ud_d;           //上下叉轮子直径
	float     s16fb_d;           //前后叉轮子直径
	
	u16      u32dpl_econder;      //底盘轮编码器线数
	u16      u32dpl_econder_reduc;//底盘轮编码器减速比
	u16      u32ud_econder;       //上下轮 编码器线数
	u16      u32ud_econder_reduc; //上下轮 编码器减速比
	u16      u32fb_econder;       //前后轮编码器线数
	u16      u32fb_econder_reduc; //前后轮编码器减速比
//*/	
