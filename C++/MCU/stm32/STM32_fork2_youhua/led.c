...
void CarID_Select(void)
{
   ...
   GPIO_InitTypeDef  GPIO_InitStructure;
	 ...
	 */
	 //叉车
	 	/* car_id
	前轮 1   PB0不接地    PB1        PB10接地
	左轮 2   PB0  接地    PB1不接地  PB10接地
	后轮 3   PB0  不接地  PB1不接地  PB10接地
	右轮 4   PB0  接地    PB1接地    PB10不接地
	
	上下 5   PB0  不接地  PB1接地    PB10不接地
	前后 6   PB0  接地    PB1不接地    PB10不接地
	*/
	 GPIO_InitTypeDef  GPIO_InitStructure;
