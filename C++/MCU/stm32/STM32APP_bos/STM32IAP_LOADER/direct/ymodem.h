...
#define PACKET_HEADER           (3) // 首字节表示大小的标识+ 编号1字节 + 编号反码1字节 
#define PACKET_TRAILER          (2) // 两个字节的16位 CRC校验位 高字节在前，低字节在后
#define PACKET_OVERHEAD         (PACKET_HEADER + PACKET_TRAILER)
#define PACKET_SIZE             (128)
#define PACKET_1K_SIZE          (1024)

#define FILE_NAME_LENGTH        (256)  //文件名存储长度  
#define FILE_SIZE_LENGTH        (16)   //文件大小存储长度
...
#define CRC16                   (0x43)  //'C' == 0x43, 需要 16-bit CRC 这里不对
