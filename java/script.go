 ...
 * @Date: 2022-07-14 08:54:30
 * @LastEditors: xiongxinwei 3293172751nss@gmail.com
 * @LastEditTime: 2022-07-15 10:48:57
 * @FilePath: \undefinedc:\Users\smile\Desktop\git\java\script.go
 * @Description:
 *
 *
 */
...
func main() {
	...
	for i := 1; i < 51; i++ {
		...
		write.WriteString("<a href=\"https://github.com/3293172751\" target=\"_blank\"><img src=\"https://img.shields.io/badge/Github-xiongxinwei-inactive?style=social&logo=github\"></a>\n")
		...
		write.WriteString("> ❤️💕💕java的学习指南,从入门到大师篇章。Myblog:[http://nsddd.top](http://nsddd.top/)\n")
		write.WriteString("---\n")
